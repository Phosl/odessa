...
const content = {
  ...
  results: {
    ...
    timeline: {
      title: 'The project, over time.',
      intro: 'Explore the expected growth of the indicators across the programme’s six phases.',
      note: 'Demonstration data · Real observations will replace these projections during monitoring.',
      controlLabel: 'Select a project phase',
      metrics: {
      ...
      items: [
        {id: 'start', label: 'Start', date: 'Sep 2026', participants: 18, sessions: 2, prototypes: 0, organizations: 3},
        {id: 'mapping', label: 'Mapping', date: 'Dec 2026', participants: 46, sessions: 6, prototypes: 1, organizations: 4},
        {id: 'academy', label: 'Academy', date: 'Jun 2027', participants: 82, sessions: 12, prototypes: 3, organizations: 5},
        {id: 'labs', label: 'Labs', date: 'Nov 2027', participants: 121, sessions: 18, prototypes: 7, organizations: 6},
        {id: 'testing', label: 'Testing', date: 'Jan 2028', participants: 154, sessions: 22, prototypes: 12, organizations: 6},
