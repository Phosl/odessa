...
import {Cta, CtaSection, EditorialSection, ImagePlaceholder, PageIntro, PageMain, SectionHeading, Timeline} from '@/components/wireframe/Wireframe'
...
export default async function ProjectPage({params}: {params: LocaleParams}) {
  ...
  return (
    <PageMain>
      <section className="section--hero"><div className="container"><PageIntro {...page.lead} index="01 / 08" /></div></section>
      ...
      <section className="section"><div className="container" data-reveal><ImagePlaceholder description={page.imageLabel} label={t('common.imagePlaceholder', {number: '01'})} /></div></section>
