...
import {Cta, CtaSection, EditorialPhoto, EditorialSection, PageIntro, PageMain, SectionHeading, Timeline} from '@/components/wireframe/Wireframe'
...
export default async function ProjectPage({params}: {params: LocaleParams}) {
  ...
  return (
    <PageMain>
      ...
      <section className="section"><div className="container" data-reveal><EditorialPhoto image={page.image} ratio="cinematic" /></div></section>
